...
async function connectToWA() {
  ...
  console.log("Connecting 💞shashimal💞");
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("💞shashimal💞 installed successful ✅");
      console.log("💞shashimal💞 connected to whatsapp ✅");

      let up = `💞shashimal💞 connected successful ✅`;
      let up1 = `Hello Shashimal, I made bot successful`;
...
app.get("/", (req, res) => {
  res.send("hey, 💞shashimal💞 started✅");
});
app.listen(port, () =>
